...
### Terms and Conditions for ALFAMON Track finance and rate
...
Application means the software program provided by the Company downloaded by You on any electronic device, named ALFAMON Track finance and rate
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ALFAMON Track finance and rate.
...
By email: mboota70999@gmail.com
Generated using Free Privacy Policy Generator
''';

  const TermsPagesWidget({super.key});
      ...
      body: Padding(
        ...
        child: Markdown(
          ...
          styleSheet: MarkdownStyleSheet.fromTheme(Theme.of(context)).copyWith(
              ...
              a: Theme.of(context).textTheme.titleLarge!.copyWith(),
              checkbox: Theme.of(context).textTheme.titleLarge!.copyWith(),
              h3: Theme.of(context).textTheme.titleLarge!.copyWith(),
              h4: Theme.of(context).textTheme.titleLarge!.copyWith(),
              h5: Theme.of(context).textTheme.titleLarge!.copyWith(),
